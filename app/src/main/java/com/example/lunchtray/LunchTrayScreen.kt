        ...
        NavHost(
            ...
            composable(route = LunchTrayScreen.Entree.name) {
                EntreeMenuScreen(
                    ...
                    onCancelButtonClicked = { cancelOrderAndNavigateToStart(viewModel = viewModel, navController = navController) },
                    onNextButtonClicked = { navController.navigate(route = LunchTrayScreen.SideDish.name) },
            ...
            composable(route = LunchTrayScreen.Checkout.name) {
                CheckoutScreen(
                    ...
                    onCancelButtonClicked = { cancelOrderAndNavigateToStart(viewModel = viewModel, navController = navController) },
                    onNextButtonClicked = { navController.navigate(route = LunchTrayScreen.Start.name) },
                    modifier = Modifier
                )
            }
        }
